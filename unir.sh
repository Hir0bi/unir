...
mostrar_descripcion_es() {
    echo "========================================"
    echo "    SCRIPT DE UNIÓN DE VIDEOS - v6.sh"
    echo "========================================"
    echo ""
    ...
    echo "    ./v6.sh video1.mp4,video2.mp4 video_unido.mp4"
    echo ""
    echo "  Unir 3 archivos de video:"
    echo "    ./v6.sh video1.mp4,video2.mp4,video3.mp4 video_unido.mp4"
    echo ""
    echo "========================================"
    echo ""
}
...
mostrar_descripcion_en() {
    ...
    echo "    ./v6.sh video1.mp4,video2.mp4 merged_video.mp4"
    echo ""
    echo "  Merge 3 video files:"
    echo "    ./v6.sh video1.mp4,video2.mp4,video3.mp4 merged_video.mp4"
    echo ""
    echo "========================================"
    echo ""
}
